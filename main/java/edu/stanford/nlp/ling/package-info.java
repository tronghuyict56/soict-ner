 ...
 * annotated word as a CoreMap (e.g., an ArrayCoreMap) from the util package.</p>
 ...
 * families of interfaces into a single view of an underlying (Array)CoreMap.</p>
 ...
 * for constructing documents from a variety of input sources.</p>
